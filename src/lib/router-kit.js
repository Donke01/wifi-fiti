...
function telemetryTestRouterKit(source) {
  ...
  const telemetryLines = [
    ...
    '  :do { :set fitiTelemetryRxBytes [/interface get \\$fitiBridge rx-byte] } on-error={}',
    '  :do { :set fitiTelemetryTxBytes [/interface get \\$fitiBridge tx-byte] } on-error={}',
  ...
  const telemetrySuffix = String.raw`&bridge=\" . \$fitiBridge . \"&telemetry=1&cpu=\" . \$fitiTelemetryCpu . \"&freeMem=\" . \$fitiTelemetryFreeMemory . \"&totalMem=\" . \$fitiTelemetryTotalMemory . \"&rx=\" . \$fitiTelemetryRxBytes . \"&tx=\" . \$fitiTelemetryTxBytes . \"&activeUsers=\" . \$fitiTelemetryActiveUsers)`;
